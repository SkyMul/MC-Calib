...
path_reprojection_error = "/home/skymul/MC-Calib/Results/reprojection_error_data.yml" 
Nb_Camera = 4
...
for i in range(0,frame_list.shape[0]):
    ...
    for j in range(0,camera_list.shape[0]):
        ...
        error_pts = fs.getNode(camera_group_id).getNode(frame_id).getNode(camera_id).getNode("error_list").mat()
