...
eul_mat_3 = mathutils.Euler((0.0, math.radians(0), 0.0), 'XYZ').to_matrix()
mat_loc_3 = mathutils.Matrix.Translation((-0.7,0,0.0))
...
# Pose of the second camera wrt to the first camera
eul_mat_4 = mathutils.Euler((0.0, math.radians(0.0), 0.0), 'XYZ').to_matrix()
mat_loc_4 = mathutils.Matrix.Translation((0.7,0.0,0.0))
